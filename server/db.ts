...
class DatabaseStore {
  ...
  private seed() {
    const seedData = getSeedData(this.hashPassword.bind(this), this.generateId.bind(this));
    this.users = seedData.users;
    this.vehicles = seedData.vehicles;
    this.trips = seedData.trips;
    this.routeStops = seedData.routeStops;
